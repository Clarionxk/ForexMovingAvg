...
void CheckForOpen()
{
   ...
   if (Open[1] > ma && Close[1] < ma)
   {
      ...
      if (UseTrailingStop && res > 0)
         OrderModify(res, 0, Bid - TrailingStop * Point, OrderTakeProfit(), 0, clrRed);
      return;
   }
   //--- buy conditions
   if (Open[1] < ma && Close[1] > ma)
   {
      ...
      if (UseTrailingStop && res > 0)
         OrderModify(res, 0, Ask + TrailingStop * Point, OrderTakeProfit(), 0, clrBlue);
      return;
   }
   //---
}
